<p align="center">
  <img src="docs/logo.svg" width="140" alt="hexa-sscb">
</p>

<h1 align="center">🛸 hexa-sscb</h1>

<p align="center"><strong>HEXA-SSCB</strong> — solid-state DC circuit breaker · 600 ns cutoff · 48 V / 100 A · 4-foundry SiP · n=6 lattice</p>

<p align="center">
  <a href="LICENSE"><img alt="License" src="https://img.shields.io/badge/license-MIT-blue"></a>
  <a href="https://doi.org/10.5281/zenodo.20102624"><img alt="DOI" src="https://zenodo.org/badge/DOI/10.5281/zenodo.20102624.svg"></a>
  <img alt="Spec" src="https://img.shields.io/badge/spec-mk1-success">
  <img alt="Cutoff" src="https://img.shields.io/badge/cutoff-600ns-informational">
  <img alt="Foundries" src="https://img.shields.io/badge/foundries-4-informational">
  <img alt="BOM" src="https://img.shields.io/badge/BOM-%2430.78-informational">
  <img alt="Verify" src="https://img.shields.io/badge/verify-10%2F10-brightgreen">
  <img alt="Family" src="https://img.shields.io/badge/family-HEXA--SSCB-blueviolet">
</p>

<p align="center">SiC MOSFET · BCD 180 nm · Σ-Δ ADC · Cortex-M4 · 48 V / 100 A · 600 ns · falsifiable · paper-frozen</p>
...
- **mk1 design package frozen** (2026-05-06) — paper + engineering pack + impact ladder (Mk.I → Mk.V) + runnable verify/build/tests/firmware surface. Silicon tape-out PLANNED.
- `verify/sscb_verify.py` 10/10 PASS · `verify/cross_doc_audit.py` 11/11 PASS · `verify/sscb_atlas_check.py` 10/10 PASS · `pytest tests/` 5 passed / 16 bench-skipped
- 3 PDFs build (pandoc + xelatex + CJK font): `sscb_mk1.pdf` · `_engineering_pack.pdf` · `_impact.pdf`
- Firmware cross-compile via `arm-none-eabi-gcc` produces 1996 B text + 3096 B BSS firmware.elf
- `.own` schema: own 1/2/3 declared — n=6 master identity · 4-foundry contractual · doc-first scope guard
- Branches: `main` (mk2 evolution: 400 V / 200 A bidirectional, 500 ns cutoff, 2027-06-01) · `mk1` archival · tag `mk1-v1.0` immutable
